        ...
        <div className="w-full bg-tl-bg py-6 border-b border-tl-border">
            <div className="px-6">
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 sm:items-center">
                    <div className="relative w-full sm:flex-1 flex items-center bg-white border border-tl-border rounded-xl h-12 px-4">
                    ...
                    <div className="w-full sm:w-80 shrink-0 flex items-center bg-white border border-tl-border rounded-xl h-12 px-4">
                        <svg className="w-4 h-4 text-tl-muted shrink-0 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">

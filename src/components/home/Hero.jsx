function Hero() {
    return (
            <>
                <div className="flex flex-row justify-center gap-4 text-xl font-sans text-tl-muted tracking-wider">
                    <p> 12,400 TUTORS </p>
                    <p> 80+ SUBJECTS </p>
                </div>
                <div className="flex flex-col justify-center py-10 text-7xl">
